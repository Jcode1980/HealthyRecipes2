<?php 
	//
	// DietaryCategoryRecipe.php
	// 
	// Created on 2017-04-21 @ 10:03 pm.
	 
	require_once BLOGIC."/BLogic.php"; 
	 
	class NutritionalBenefitRecipe extends BLGenericRecord 
	{ 
		...
		{ 
			return "NutritionalBenefitRecipe"; 
		} 
		 
		public function pkNames() 
		{ 
			return array("nutritionalBenefitID", "recipeID");
		}
