<?php 
	//
	// NutritionalBenefit.php
	// 
	// Created on 2017-04-21 @ 10:03 pm.
	 
	require_once BLOGIC."/BLogic.php"; 
	 
	class NutritionalBenefit extends BLGenericRecord 
	{ 
		...
		*/
		...
		public static function allNutritionalBenefits(){
			return BLGenericRecord::find("NutritionalBenefit", null);
		}
